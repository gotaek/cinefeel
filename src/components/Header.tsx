      ...
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="relative">
          ...
          <input 
            ...
            className="bg-neutral-900 border border-neutral-800 rounded-full py-2 pl-10 pr-4 text-xs md:text-sm focus:outline-none focus:ring-2 focus:ring-red-500/50 w-40 md:w-64"
          />
        </div>
      </div>
    </header>
