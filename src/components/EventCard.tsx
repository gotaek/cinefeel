...
export const EventCard: React.FC<EventCardProps> = ({ event, onClick }) => {
  ...
  return (
    ...
    >
      <div className={`relative aspect-[2/3] overflow-hidden rounded-2xl bg-neutral-900 border border-neutral-800 shadow-lg transition-all duration-300 ${isEnded ? 'grayscale opacity-60' : 'group-hover:shadow-red-500/10 group-hover:-translate-y-1'}`}>
